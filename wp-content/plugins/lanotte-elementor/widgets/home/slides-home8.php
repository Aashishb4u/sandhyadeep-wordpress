 ...
 * @since 1.0.0
 */
class BdevsSlidesHome8 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slides Home 8', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_slides_home_8',
			[
				'label' => esc_html__( 'Slides Home 8', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title',
...
<section id="hero-8" class="bg--moccasin hero-section division">
	<div class="container">	
		<div class="row d-flex align-items-center">
			<div class="col-lg-10 offset-lg-1 text-center">
				<?php if (('' != $settings['title']) && ($settings['show_title'])): ?>
					<div class="hero-8-txt">
						<h2 class="deep-brown--color"><?php echo wp_kses_post($settings['title']); ?></h2>
					</div>
				<?php endif; ?>
				<?php if ('' != $settings['image']['url']): ?>
					<div class="hero-8-img">
