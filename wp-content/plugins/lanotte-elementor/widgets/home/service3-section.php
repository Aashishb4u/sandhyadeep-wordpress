 ...
 * @since 1.0.0
 */
class BdevsService3Section extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Service 3 Section', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'service3section', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_service3_section',
			[
				'label' => esc_html__( 'Service 3 Section', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
