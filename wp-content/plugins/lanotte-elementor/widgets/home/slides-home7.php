 ...
 * @since 1.0.0
 */
class BdevsSlidesHome7 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Slides Home 7', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_slides_home_7',
			[
				'label' => esc_html__( 'Slides Home 7', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
			[
				...
				'fields' => [
					[
						'name'        => 'bg_slide_item',
						'label'       => esc_html__( 'Image Slide Item', 'bdevs-elementor' ),
...
<section id="hero-7" class="hero-section division">
	<div class="container">	
		<div class="hero-7-wrapper bg-fixed">
					...
					<ul class="slides">
						...
						?>
							<li id="slide-<?php echo esc_attr($i) ; ?>">
								<img src="<?php echo wp_kses_post($item['bg_slide_item']['url']); ?>" alt="slide-background">
											...
											<div class="col-md-7">
												<div class="caption-txt black--color">
													<?php if ('' != $item['title_item']): ?>
														<h2><?php echo wp_kses_post($item['title_item']); ?></h2>
													<?php endif; ?>
													...
													<?php if (('' != $item['link_btn_item']) && ('' != $item['text_btn_item'])): ?>
														<a href="<?php echo wp_kses_post($item['link_btn_item']); ?>" class="btn rose--btn tra-black--hover">
