	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Choose the beauty', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Peace, Love & Nails.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
						...
						<div class="sbox-7 mb-40 wow fadeInUp" data-wow-delay="0.3s">
							<div class="sbox-7-img mb-30">
								<div class="hover-overlay"> 
									<img class="img-fluid" src="<?php echo wp_kses_post($item['img_item']['url']); ?>" alt="service-image" />
