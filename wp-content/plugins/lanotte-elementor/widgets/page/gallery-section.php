 ...
 * @since 1.0.0
 */
class BdevsGallerySection extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Gallery Section', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'gallerysection', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_gallery_section',
			[
				'label' => esc_html__( 'Gallery Section', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'text1',
		...
		$this->add_control(
			'link',
			[
				'label'       => __( 'Link Follow', 'bdevs-elementor' ),
				'type'        => Controls_Manager::TEXT,
		...
		$this->add_control(
			'text2',
			[
				'label'       => __( 'Text Follow', 'bdevs-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your text follow', 'bdevs-elementor' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Section Gallery Items', 'bdevs-elementor' ),
...
<section id="gallery" class="wide-100 gallery-section division">
	<div class="container">
		<div class="row justify-content-center">	
			<div class="col-lg-10 col-xl-8">
				<div class="section-title title-01 mb-50">
					<h4 class="h4-lg black--color">
				...
				<div class="col">
					<div id="img-3-1" class="gallery-image">
						<div class="hover-overlay">
							...
							<div class="image-data white--color">
