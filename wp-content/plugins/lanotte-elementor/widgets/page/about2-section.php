 ...
 * @since 1.0.0
 */
class BdevsAbout2Section extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About 2 Section', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_about2_section',
			[
				'label' => esc_html__( 'About 2 Section', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Section About Time Items', 'bdevs-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Time Schedule', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			<div class="col-md-6 order-first order-md-2">
				<div class="txt-block right-column wow fadeInLeft">
					...
					<?php if (('' != $settings['title']) && ($settings['show_title'])): ?>
						<h3 class="h3-xs"><?php echo wp_kses_post($settings['title']); ?></h3>
					<?php endif; ?>
