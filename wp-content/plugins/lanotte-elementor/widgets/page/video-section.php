 ...
 * @since 1.0.0
 */
class BdevsVideoSection extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Video Section', 'bdevs-elementor' );
	}
...
<section id="video-2" class="rel video-section bg-video">
	<?php if ('' != $settings['video']['url']): ?>
		<video src="<?php echo wp_kses_post($settings['video']['url']); ?>" autoplay loop playsinline muted></video>
	<?php endif ?>
	<div class="bg-fixed video-2-overlay division">
		<div class="container">
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="video-2-txt text-center white--color">
						<?php if (('' != $settings['title']) && ($settings['show_title'])): ?>
							<h2 class="h2-title-xs"><?php echo wp_kses_post($settings['title']); ?></h2>
						<?php endif; ?>
						<?php if (('' != $settings['subtitle']) && ($settings['show_subtitle'])): ?>
							<p class="p-title-xl"><?php echo wp_kses_post($settings['subtitle']); ?></p>
						<?php endif; ?>
