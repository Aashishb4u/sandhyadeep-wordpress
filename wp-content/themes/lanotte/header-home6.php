...
<body>
	...
	<div id="stlChanger">
		<div class="blockChanger bgChanger">
			<a href="#" class="chBut bg--plum icon-xs"><span class="flaticon-settings"></span></a>
						...
						<nav class="wsmenu clearfix">
							...
							if ($hide_button == 0 ): ?>
								<li class="nl-simple" aria-haspopup="true">
									<a href="<?php print wp_specialchars_decode($link_button); ?>" class="btn plum--btn tra-deep-brown--hover last-link">
